/*
  © (ɔ) QuoInsight
*/
// [ http://www.functionx.com/csharp1/winprog/Lesson01.htm ]
using System;
  ...
  class myMainForm : Form {
    ...
    static int Main() {
      ...
      frmMain = new myMainForm();
        ...
        frmMain.Opacity = 0.3; // default is 1.00
        frmMain.BackColor = System.Drawing.Color.Lime;
        frmMain.TransparencyKey = System.Drawing.Color.Lime;
        //frmMain.FormBorderStyle = FormBorderStyle.None;
        frmMain.Text = string.Empty;  frmMain.ControlBox = false;
        //frmMain.FormBorderStyle = FormBorderStyle.SizableToolWindow; // [ https://msdn.microsoft.com/en-us/library/hw8kes41(v=vs.110).aspx ]
        frmMain.MouseDown += new MouseEventHandler(frmMain.onMouseDownEnableMove);
          ...
          //picBox1.MouseMove += new MouseEventHandler(frmMain.onMouseMoveEnableDragDrop);
   ...
   /*----------------------------------------------------------------*/
    ...
    private void onMouseDownEnableMove(object sender, MouseEventArgs e) {
      var parentForm = ((Control)sender).FindForm(); ReleaseCapture();
      SendMessage(parentForm.Handle, (int)WindowsMessages.WM_NCLBUTTONDOWN, 0x2, 0);  // 0x2=HT_CAPTION
    }

    private void onMouseMoveEnableDragDrop(object sender, System.Windows.Forms.MouseEventArgs e) {
    ...
    private void onDragEnterEnableFileDrop(object sender, System.Windows.Forms.DragEventArgs e) {
    ...
    public enum WindowsMessages: int { // [ http://www.codeproject.com/Articles/2171/Windows-Message-ID-constants ]
